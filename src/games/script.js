...
function key_init() {
    console.log("key initiliaze"),
        keyList = {
            arrow_left: { f_up: void 0, f_down: void 0 },
            arrow_right: { f_up: void 0, f_down: void 0 },
            arrow_up: { f_up: void 0, f_down: void 0 },
            arrow_down: { f_up: void 0, f_down: void 0 },
            space: { f_up: void 0, f_down: void 0 },
            w: { f_up: void 0, f_down: void 0 },
            a: { f_up: void 0, f_down: void 0 },
            s: { f_up: void 0, f_down: void 0 },
            d: { f_up: void 0, f_down: void 0 },
            f: { f_up: void 0, f_down: void 0 },
            g: { f_up: void 0, f_down: void 0 },
            any_key: { f_up: void 0, f_down: void 0 }
        }
}
...
document.onkeydown = function(e) {
    switch (e.preventDefault(), e.keyCode ? e.keyCode : e.which) {
        ...
        case 70:
        case 102:
            null != keyList.f.f_down && keyList.f.f_down();
            break;
        case 71:
        case 103:
            null != keyList.g.f_down && keyList.g.f_down();
            break;
        case 32:
...
document.onkeyup = function(e) {
    switch (e.preventDefault(), e.keyCode ? e.keyCode : e.which) {
        ...
        case 70:
        case 102:
            null != keyList.f.f_up && keyList.f.f_up();
            break;
        case 71:
        case 103:
            null != keyList.g.f_up && keyList.g.f_up();
            break;
        case 32:
